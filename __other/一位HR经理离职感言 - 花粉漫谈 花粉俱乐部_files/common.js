...
function ajaxmenu(ctrlObj, timeout, cache, duration, pos, recall, idclass, contentclass) {
	...
	//[TODO]s00167165, 20140718, modified for DTS2014031802387 [begin]
	//var menuid = ctrlid + '_menu';
	var menuid = ctrlObj.id + '_menu';
	//[TODO]s00167165, 20140718, modified for DTS2014031802387 [end]
	var menu = $(menuid);
...
function setMenuPosition(showid, menuid, pos) {
	...
	//TODO f00190369 begin 搜索框选择框 浮动时定位位置
	if(pos == '55'){
		var parObj = $('nv');
		pos = parObj.style.position == 'fixed' ? pos : '43';
	}
	...
	if(direction == 0 || menuObj.scrolly || direction == 5) {
		if(BROWSER.ie && BROWSER.ie < 7) {
			if(direction == 0) mt += scrollTop;
		} else {
			if(menuObj.scrolly ||  direction == 5) mt -= scrollTop;
