(function(){
    $(function(){
        ...
        var second_pop_str="<div class='pop_edit ask_second comm_ask_second'><h3>提问</h3><a href='#' nodeType='close' class='close'>×</a><div class='context'><div class='err_div'><span class='err_ico'></span>"+
            "<span class='err_txt'>该问题已存在，请勿重复提问</span></div>"+
            "<div class='input_div'><input id='askInputSecond' type='text' placeholder='输入问题，查看是否存在相似的问题'/></div><div class='second_se'>问题描述：</div>"+
        ...
        $("#previw-button").bind("click", function(){
            ...
            if (inp.css("display") != "none") {
                inp.hide();
                pre.show();
                $("#wmd-preview")[0].style.cssText="display:block;width:628px;height:200px;overflow:auto;padding-top:0;padding-bottom:0;padding:3px 3px;"
            } else {
                inp.show();
                pre.hide();
            }
...
//判断是不是有快速回复，返回顶部end
        ...
        var coin_flag=false;
//判断是否首次点击提问按钮
        var check_accept_rules_url = "//ask.csdn.net/users/check_accept_rules.js";
//提问时，标题录入框的自动完成
        var ask_topic_autocomplete_url = "//ask.csdn.net/questions/autocomplete.js";
//提问时，光标离开标题后的推荐标签
       // var ask_topic_tag_suggest_url = " http://ask.csdn.net/questions/tag_autocomplete.js";
		 var ask_topic_tag_suggest_url ="//internalapi.csdn.net/myapi/ask_topic/ask_topic_tag_suggest?x-acl-token=Yz3GAP4stGOIrLaIrnDed-uThp8K";
//提问时，发布问题的地址
        var create_question_url = "//ask.csdn.net/questions/create_question.js";
//验证C币
        var valid_coin=   "//ask.csdn.net/users/get_scores.js";
		//问题链接跳转
		var ask_detail_url =  "//ask.csdn.net/questions/";
...
//绑定自动搜索
                ...
                $submit.bind( 'click', function () {
                    ...
                    if( !valid($(" .comm_ask_second #wmd-input"),_content,"问题描述",30,500)){
                        return false;
                    };
...
//获取后台推荐标签
        function  loadRecommTags( _title, _content){
            ...
            $.ajax({
                type: "get",
                url: ask_topic_tag_suggest_url,
                data:{title: _title, body: _content, size: 4},
                dataType: "jsonp",
                jsonp: "callback",
