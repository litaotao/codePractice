...
r.mod_num++,n&&i==t.getItem(a+"_ver"))try{
var s="//# sourceURL="+c+"\n//@ sourceURL="+c;
...
for(var o,t,n="",a=[],i={},c=0,s=e.length;s>c;++c)/^\/(.*?)\//.test(e[c]),RegExp.$1&&(t=RegExp.$1,
n=i[t],n?(o=n+","+e[c],o.length>1024?(a.push(n),n=location.protocol+"//res.wx.qq.com"+e[c],
i[t]=n):(n=o,i[t]=n)):(n=location.protocol+"//res.wx.qq.com"+e[c],i[t]=n));
