...
{
	var unit_id     = "1201909";
	var client_ip   = "101.226.178.72";
	var server_time = "1417661233";
	var verify_code = "ac887e5e";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1201909/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
