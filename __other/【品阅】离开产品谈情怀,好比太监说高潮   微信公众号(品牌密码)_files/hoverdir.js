  ...
  function showmore() {
	  if($(".c2_l").height()<400){
	  $(".c2_l").stop(true,false).animate({height : "400px"},500);
	  $(".c2_slide").stop(true,false).animate({height : "380px"},500);
	  $(".c2_slide_c").stop(true,false).animate({height : "380px"},500);
	  $(".c2_slide_more").html("隐藏更多")
	  }else{
	  $(".c2_l").stop(true,false).animate({height : "150px"},500);
	  $(".c2_slide").stop(true,false).animate({height : "120px"},500);
	  $(".c2_slide_c").stop(true,false).animate({height : "120px"},500);
	  $(".c2_slide_more").html("显示更多")
	  }
  }
