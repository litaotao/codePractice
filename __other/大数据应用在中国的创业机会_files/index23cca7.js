...
var o=r.item(n),c=o.getAttribute("data-src")||o.getAttribute("src");
if(c){
for(;-1!=c.indexOf("?tp=webp");)c=c.replace("?tp=webp","");
o.dataset&&o.dataset.s&&c.isCDN()&&(c=c.replace(/\/640$/,"/0")),c.isCDN()&&(c=a.addParam(c,"wxfrom","3",!0)),
e.is_https_res&&(c=c.http2https()),i.push(c),function(e){
s.on(o,"click",function(){
return t(e,i),!1;
});
}(c);
}
...
var s=e("biz_common/dom/event.js"),r=e("biz_wap/jsapi/core.js"),a=e("biz_common/utils/url/parse.js");
...
var t=document.getElementById("likeNum"),i=document.getElementById("readNum"),n=x.read_num,r=x.like_num;
...
var i=document.getElementById("js_reward_list"),n="",r='<span class="reward_user_avatar radius_avatar"><img src="__src__" alt=""></span>',o=0;
if(i){
e.self_head_img&&(o++,n+=r.replace("__src__",e.self_head_img));
for(var d=0,s=e.reward_head_imgs.length;s>d&&(o++,n+=r.replace("__src__",e.reward_head_imgs[d]),
o!=getMaxHeadImg());++d);
o>getMaxHeadImg()/3&&(i.className+=" tl"),i.innerHTML=n;
}
var m=document.getElementById("js_reward_area");
m&&(m.style.display="block",DomEvent.on(window,"scroll",reportReward));
var p=document.getElementById("js_reward_inner");
p&&o>0&&(p.style.display="block");
}
...
async:!0
}),DomEvent.off(window,"scroll",reportReward));
}
...
ads:{},
num:0
},window.adRenderData||window.appmsgstat)fillVedio(window.appmsgticket),fillData({
