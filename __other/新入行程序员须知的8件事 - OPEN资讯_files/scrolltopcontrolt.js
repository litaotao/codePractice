...
var scrolltotop={
	...
	controlHTML: '<img src="images/gotop.gif" style="width:35px; height:35px;" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
	...
	controlHTML:function(IMG){
		scrolltotop.controlHTML=IMG;
	},
	init:function(){
