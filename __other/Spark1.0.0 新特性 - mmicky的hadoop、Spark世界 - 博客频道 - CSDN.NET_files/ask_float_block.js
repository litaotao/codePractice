(function(){
    $(function(){
        ...
        var afont = prot + "//ask.csdn.net/assets/ask_float_fonts_css.css";//该样式文件名称要根据每次发布后的动态名称来修改。//font-awesome.min-58872ef19fd8eb4c71bc6667c200b0c0.css";
        ...
        if(window.quickReplyflag) {
            ...
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-ask-float-block'  title='提问按钮' style='top:"+(back_top_value-82)+"px'></a>"+
                "<a id='com-edu-call-center'  title='学院客服' style='top:"+(back_top_value-41)+"px' target='_blank' href='http://wpa.qq.com/msgrd?v=3&amp;uin=2194666820&amp;site=qq&amp;menu=yes'></a>"+
