...
getHeight = function(element) {
	return element.offsetHeight+25;/*the 25 is add by dfliu for feedread*/
}
...
*/
	var feedread = document.getElementById('feedread');
	if (feedrss) {
		new GhostlyMenu(feedread, align);
	}
...
if (document.addEventListener) {
	...
	document.write('<script id="__ie_onload_for_subordinate" defer src="javascript:void(0)"></script>');
	var script = document.getElementById('__ie_onload_for_subordinate');
