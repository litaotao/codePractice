                ...
                <div id="cappsarea123" class="icon on-apps-icon">\
                  ...
                  <div class="detail">\
                    <dl>\
                      ...
                      <dd> <a href="http://job.csdn.net?ref=toolbar" target="_blank">招聘<img src="//csdnimg.cn/public/common/toolbar/images/new.gif" style="margin-top: -26px; width: 23px;"></a></dd>\
                      <dd> <a href="http://edu.csdn.net?ref=toolbar" target="_blank">学院<img src="//csdnimg.cn/public/common/toolbar/images/new.gif" style="margin-top: -26px; width: 23px;"></a></dd>\
                      ...
                      <dd> <a href="http://mall.csdn.net?ref=toolbar" target="_blank">C币兑换<img src="//csdnimg.cn/public/common/toolbar/images/new.gif" style="margin-top: -26px; width: 23px;"></a></dd>\
                    </dl>\
                  </div>\
