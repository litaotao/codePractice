(function(){
    $(function(){
        ...
        var second_pop_str="<div class='pop_edit ask_second comm_ask_second'><h3>提问</h3><span class='ask_float_span'>您的问题将会被发布在“<a class='ask_float_channel' href='//ask.csdn.net' target='_blank' style='cursor:pointer'>技术问答</a>”频道</span><a href='#' nodeType='close' class='close'>×</a><div class='context'><div class='err_div'><span class='err_ico'></span>"+
            ...
            "<div class='pop_cm cm_add_img'><input type='text' placeholder='图片地址' id='af_cm_img_url'><input type='text' placeholder='图片说明' id='af_cm_img_alt'><div class='text-right'><span class='btn btn-default btn-sm' id='add_img_btn'>插入图片</span> </div> </div></div> "+
            "<textarea id='editor110' rows='8'></textarea>"+
        ...
        if(window.quickReplyflag) {
            ...
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-ask-float-block'  title='提问按钮' style='top:"+(back_top_value-82)+"px'></a>"+
                "<a id='com-edu-call-center'  title='学院客服' style='top:"+(back_top_value-41)+"px' target='_blank' href='http://wpa.qq.com/msgrd?v=3&amp;uin=2355263780&amp;site=qq&amp;menu=yes'></a>"+
                "<a id='com-d-top-a'  style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a></div>";
        } else if (window.bbsInfoflag) {
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-ask-float-block'  title='提问按钮' style='top:"+(back_top_value-164)+"px'></a>"+
                "<a id='com-quick-reply-bbs' title='快速回复' style='top:"+(back_top_value-123)+"px'></a>" +
                "<a id='com-back-channel' title='回到频道' style='top:"+(back_top_value-82)+"px'></a>" +
                "<a id='com-back-home' title='回到首页' style='top:"+(back_top_value-41)+"px'></a>" +
                "<a id='com-d-top-a' style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a> </div>";
        } else {
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-ask-float-block'  title='提问按钮' style='top:"+(back_top_value-41)+"px'></a>"+
                "<a id='com-d-top-a'  style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a></div>";
        }
        ...
        editor.render(document.getElementById('editor110'));
//初始化Markdown控件
//        (function($) {
//            var f = $;
//            var i,
