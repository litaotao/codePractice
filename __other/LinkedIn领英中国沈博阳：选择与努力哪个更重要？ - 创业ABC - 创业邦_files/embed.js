(function(e, t, n) {
    function ut(e, t) {
        for (var n in t) t[n] && (e[n] ? e[n].set(t[n]) : e[n] = new Z(t[n]))
    }
    function at(e, t) {
    ...
    p = function(e) {
        ...
        return n.href = e,
        S.hrefNormalized ? n.href: n.getAttribute("href", 4)
    },
    d = {
        start: 0,
        end: 0
    ...
    b = e.DUOSHUO = {
        ...
        libs: {
            jQuery: y + "/libs/embed.compat.js?24f8ca3f.js",
            smilies: "/statics/js/embed.smilies.js?921e8eda.js",
        ...
        require: function(e, t) {
            if (typeof e == "string") b.loaded[e] ? t() : j(b.libs[e],
            function() {
                b.loaded[e] = !0,
                t()
            });
                ...
                for (n = 0; n < e.length; n++)(function(i) {
                    if (b.loaded[e[n]]) return;
                    r = !1,
                    j(b.libs[i],
                    function() {
                        b.loaded[i] = !0;
                        for (var n = 0; n < e.length; n++) if (!b.loaded[e[n]]) return;
                        t()
                    })
                })(e[n]);
                r && t()
        ...
        ajax: function(e, t, r, o, u) {
            ...
            r.v = b.version,
            a ? r.jwt = a: U.remote_auth && (r.remote_auth = U.remote_auth);
            if (s && i && i.parse) {
                var f = new s;
            ...
            b[h] = function(e) {
                ...
                default:
                    u && u(e),
                    F("\u51fa\u9519\u5566(" + e.code + "): " + e.errorMessage),
                    e.errorTrace && F(e.errorTrace)
                }
            },
            r.callback = "DUOSHUO['" + h + "']",
            j(b.hostUrl + t + "&" + b.param(r))
        },
        ...
        setCustomStyle: function(e) {
            c || (c = t.createElement("style"), c.type = "text/css", a.appendChild(c)),
            e = e.replace(/\}/g, "}\n");
    ...
    S = b.support = function() {
        ...
        return E = !s && typeof n.style.maxHeight == "undefined",
    ...
    P = b.Views = {},
    H = b.Callbacks = {},
    B = b.openDialog = function(e) {
        return b.dialog !== n && b.dialog.el.remove(),
        b.dialog = (new P.Dialog('<div class="ds-dialog"><div class="ds-dialog-inner ds-rounded"><div class="ds-dialog-body">' + e + '</div><div class="ds-dialog-footer"><a href="http://duoshuo.com/" target="_blank" class="ds-logo"></a><span>\u793e\u4f1a\u5316\u8bc4\u8bba\u6846</span></div><a class="ds-dialog-close" href="javascript:void(0)" title="\u5173\u95ed"></a></div></div>')).open()
    },
    ...
    I = b.smilies = {},
    q = ["EmbedThread", "RecentComments", "RecentVisitors", "TopUsers", "TopThreads", "LoginWidget", "ThreadCount"],
    R = 0,
    U,
    z = function() {
        var e = {},
        t = 0;
        for (; t < arguments.length; t++) arguments[t] && at(e, arguments[t]);
        var n = b.param(e);
        return n ? n : ""
    },
    W = function() {
        ...
        return e ? {
            ...
            remote_auth: U.remote_auth
        }: n
    },
    X = function() {
        return ! U && (U = e.duoshuoQuery) && et.trigger("queryDefined"),
        U
    };
    for (var V in Object.prototype) return alert("Object.prototype\u4e0d\u4e3a\u7a7a\uff0c\u8bf7\u4e0d\u8981\u7ed9Object.prototype\u8bbe\u7f6e\u65b9\u6cd5");
    var $ = b.templates = {
        userUrl: function(e) {
            return e.url
        },
        ...
        avatarImg: function(e, t) {
            return '<img onerror="this.onerror=null;this.src=\''+tt.data.default_avatar_url+'\'" src="' + h($.avatarUrl(e, t)) + '" alt="' + h(e.name) + '"' + (t ? ' style="width:' + t + "px;height:" + t + 'px"': "") + "/>"
        },
        avatar: function(e, t) {
            var n = $.avatarImg(e, t),
            r = $.userUrl(e);
            return r ? '<a rel="nofollow author" target="_blank" href="' + h(r) + '" title="' + h(e.name) + '">' + n + "</a>": n
        },
        ...
        indicator: m('<div id="ds-indicator"></div>'),
        waitingImg: m('<div id="ds-waiting"></div>'),
        serviceList: function(e) {
            var t = '<ul class="ds-service-list">',
            n = ["weibo", "qqt"],
            r = 0;
            for (; r < n.length; r++) t += $.loginItem(n[r], e);
        ...
        additionalServices: function(e) {
            ...
            //n = ["kaixin", "renren", "douban", "netease", "sohu", "baidu", "google"],
            n = [],
            r = 0;
            for (; r < n.length; r++) t += $.loginItem(n[r], e);
            return t + "</ul>"
        ...
        loginUrl: function(e, t) {
            return t || (t = {}),
            U.sso && U.sso.login && (t.sso = 1, t.redirect_uri = U.sso.login),
            b.hostUrl + "/index.php?m=member&c=auth&a=init&redirect_uri=1&anchor=comments&type=" + e + "&" + z(t)
        },
        bindUrl: function(e) {
            return b.hostUrl + "/index.php?m=member&c=auth&a=bind&redirect_uri=1&anchor=comments&type=" + e + "&" + z(U.sso && U.sso.login ? {
                sso: 1,
                redirect_uri: U.sso.login
            }: null, W())
        },
        logoutUrl: function() {
            return b.hostUrl + "/index.php?m=member&c=index&a=logout&redirect_uri=1&anchor=comments&" + z(U.sso && U.sso.logout ? {
                sso: 1,
                redirect_uri: U.sso.logout
            }: null)
        },
        likePost: function(e) {
    ...
    K = function(e) {
        var t = [];
        for (var n in e) t.push('<input type="hidden" name="' + n + '" value="' + h(e[n]) + '" />');
        return t.join("\n")
    };
    for (; R < q.length; R++) b[q[R]] = function(e) {
        return function(t, n) {
            n = n || {},
            n.type = e,
            t && !T[t] && (T[t] = n),
            b.initSelector && b.initSelector(t, n)
        }
    } (q[R]),
    b["create" + q[R]] = function(e) {
        return function(n, r) {
    ...
    G = b.Class = function() {};
    G.extend = function(e) {
        function r() { ! Q && this.init && this.init.apply(this, arguments)
        }
        Q = 1;
        var t = new this;
        Q = 0;
    ...
    function() {
        var e = U.short_name;
            d = U.domain,
            r = U.remote,
        b.hostUrl = e ? "http://" + (d ? d : "www." + b.DOMAIN) : (r ? r : b.REMOTE),
        U.theme && ht(U.theme);
        if (o) {
            var t = o["ds_site_" + e],
            n = o["ds_lang_" + e];
            t && tt.reset(i.parse(t)),
            n && at(C, i.parse(n))
        }
    }),
    X(),
    b.loaded.jQuery && (b.jQuery = e.jQuery),
    b.require("jQuery",
    function() {
        function dt(e, t, n) {
            if (e.find(".ds-post[data-post-id=" + t.post_id + "]")[0]) return;
            return e.find(".ds-post-placeholder").remove(),
            i($.post(t, n)).hide()[n.order == "asc" ? "appendTo": "prependTo"](e).slideDown(function() {})
        }
        function vt(e, t) {
            var n;
            ...
            function(e) {
                ...
                L("/index.php?m=comment&c=index&a=vote", {
            ...
            function(e) {
                ...
                n = st[t.attr("data-post-id")];
                return b.repostDialog(n, ""),
                !1
            }).delegate("a.ds-post-delete", "click",
            function(t) {
                if (confirm("\u786e\u5b9a\u8981\u5220\u9664\u8fd9\u6761\u8bc4\u8bba\u5417\uff1f")) {
                    var n = i(this).closest(".ds-post-self");
                    L("/index.php?m=comment&c=index&a=remove", {
            ...
            function(e) {
                if (confirm("\u786e\u5b9a\u8981\u4e3e\u62a5\u8fd9\u6761\u8bc4\u8bba\u5417\uff1f")) {
                    var t = i(this).closest(".ds-post-self");
                    L("/index.php?m=comment&c=index&a=report", {
            ...
            function(r) {
                ...
                o.removeClass("ds-reply-active");
                    ...
                    n ? n.actionsBar.removeClass("ds-reply-active") : (n = new P.Replybox(e), n.render(!0).el.addClass("ds-inline-replybox").detach()),
                    n.el.find("[name=parent_id]").val(u.attr("data-post-id")),
                    n.el.find("[name=root_id]").val((u.attr("data-root-id") !=0 ? u.attr("data-root-id") : u.attr("data-post-id"))),
            ...
            function(e) {
                ...
                if (n.attr("data-root-id") == 0) {
                    ...
                    o[0] ? o.remove() : (o = i('<ul class="ds-children"></ul>').insertAfter(n), k("/api/posts/listComments", bt({
                        post_id: r
                    }),
                    function(e) {
                        c(e),
            ...
            S.touch || this.delegate("a.ds-comment-context", "mouseenter",
            function(t) {
                var n = this;
                if (bubbleOutTimer && Q.owner == n) clearTimeout(bubbleOutTimer),
                bubbleOutTimer = 0;
                else {
                    var r = i(n);
                    et = setTimeout(function() {
                        ...
                        try {
                            if (r.hasClass("ds-comment-context")) G.attr("id", "ds-ctx-bubble").attr("data-post-id", r.attr("data-post-id")).html('<ul id="ds-ctx">' + $.ctxPost(st[r.attr("data-parent-id")].data) + "</ul>" + '<div class="ds-bubble-footer"><a class="ds-ctx-open" href="javascript:void(0);">\u67e5\u770b\u5bf9\u8bdd</a></div>');
                                ...
                                ot[f] ? G.html($.userInfo(ot[f].data)) : k("/api/users/profile", bt(a),
                                function(e) {
                                    var t = e.response;
                                    ot[f] ? ot[f].set(t) : ot[f] = new Z(t),
                                    Q.owner == n && G.html($.userInfo(t))
                                })
                            }
                            Q.css({
                                bottom: o,
        ...
        function bt(e) {
            var n = {
                require: "site,visitor,serverTime,lang" + (yt++?"": ",unread,log,extraCss"),
                site_ims: o && o["ds_site_" + U.short_name + ":timestamp"],
                lang_ims: o && o["ds_lang_" + U.short_name + ":timestamp"],
                referer: t.referrer
            };
            U.stylePatch && (n.style_patch = U.stylePatch);
            for (var r in n) n[r] && (!E || encodeURIComponent(n[r]).length < 200) && (e[r] = n[r]);
            return e
        }
        var i = b.jQuery,
        s = i(e),
        a = i(t),
        c = b.loadRequire = function(e) {
            e.serverTime && (l = (new Date).getTime() - e.serverTime * 1e3),
            e.visitor && (!nt.data && e.visitor.user_id && u && !u.checkPermission() && _({
                logged_user_id: e.visitor.user_id
            }), nt.reset(e.visitor)),
            e.site && (tt.reset(e.site), ct("ds_site_" + U.short_name, e.site, e.serverTime)),
            !b.theme && tt.data.theme && ht(tt.data.theme),
            e.lang && (at(C, e.lang), ct("ds_lang_" + U.short_name, e.lang, e.serverTime));
            if (e.stylesheets) for (var t = 0; t < e.stylesheets.length; t++) b.injectStylesheet(e.stylesheets[t]);
            e.style && b.setCustomStyle((e.style || "") + b.compileStyle(U.component_style)),
            e.unread && rt.reset(e.unread)
        },
        m = function(e) {
            e.stopPropagation()
        },
        ...
        O = function(t, n) {
            ...
            return e.open(n + (n.indexOf("?") == -1 ? "?": "&") + b.param({
        ...
        M = function(e, t) {
            S.authInWin && e.find(t || "a.ds-service-link").click(function(e) {
                ...
                if (!t || !b.serviceNames[t[2]]) return;
                return ! O(t[2], this.href)
            })
        },
        H = function(e) {
            return S.touch && e.addClass("ds-touch"),
            x("transition") || e.addClass("ds-no-transition"),
            E && e.addClass("ds-ie6"),
        ...
        V = function(e) {
            var t = {
                "unread-comments": {
                    title: "\u65b0\u7559\u8a00\u53ca\u56de\u590d",
                    apiUrl: "/api.php?op=users&do=unreadcomments",
                    tmpl: function(e) {
                    ...
                    read: function(e) {
                        ...
                        L("/index.php?m=comment&c=index&a=read", {
                            thread_id: t
                        }),
                        rt.data.comments--
                    }
                ...
                "unread-notifications": {
                    title: "\u7cfb\u7edf\u6d88\u606f",
                    apiUrl: "/index.php?m=comment&c=index&a=unreadnotifications",
                    tmpl: function(e) {
                    ...
                    read: function(e) {
                        ...
                        L("/index.php?m=comment&c=index&a=readnotifications", {
                            notification_id: t
                        }),
            ...
            n = B("<h2>" + t.title + "</h2>" + '<ul class="ds-unread-list"></ul>');
        ...
        b.resetNotify = function() {
            ...
            } [tt.data.notify_position]).delegate(".ds-notify-unread a", "click",
            function(e) {
                return V(i(this).data("type")),
                !1
            }).appendTo(t.body)),
        ...
        rt.on("reset", b.resetNotify),
        $.replybox = function(e, t) {
            var n = e.options,
            r = nt.data,
            i = [],
            s = "",
            ...
            s += $.serviceIcon(a, !r.repostOptions[a]);
            return '<div class="ds-replybox"><a style="cursor:default;" class="ds-avatar"' + (lt() ? ' href="javascript:void(0);" onclick="return false"': ' href="javascript:void(0);"') + ">" + $.avatarImg(r) + "</a>" + '<form method="post">' + K(u) + '<div class="ds-textarea-wrapper ds-rounded-top">' + '<textarea name="message" title="Ctrl+Enter\u5feb\u6377\u63d0\u4ea4" placeholder="' + h(C.leave_a_message) + '"></textarea>' + '<pre class="ds-hidden-text"></pre>' + "</div>" + '<div class="ds-post-toolbar">' + '<div class="ds-post-options ds-gradient-bg">' + '<span class="ds-sync">' + (!lt() && n.use_repost && s ? '<input id="ds-sync-checkbox' + (t ? "-inline": "") + '" type="checkbox" name="repost" ' + (o ? 'checked="checked" ': "") + 'value="' + i.join(",") + '"> <label for="ds-sync-checkbox' + (t ? "-inline": "") + '">' + C.share_to + "</label>" + s: "") + "</span>" + "</div>" + '<button class="ds-post-button" type="submit">' + h(C.post) + "</button>" + '<div class="ds-toolbar-buttons">' + (n.use_smilies ? '<a class="ds-toolbar-button ds-add-emote" title="\u63d2\u5165\u8868\u60c5"></a>': "") + (n.use_images && n.parse_html_enabled ? '<a class="ds-toolbar-button ds-add-image" title="\u63d2\u5165\u56fe\u7247"></a>': "") + "</div>" + "</div>" + "</form>" + "</div>"
        },
        P.Replybox = function(e) {
            this.embedThread = e
        },
        P.Replybox.prototype = {
            render: function(e) {
                function x(e) {
                    e.data("submitting", !0),
                    e.find(".ds-post-button").addClass("ds-waiting").html(C.posting)[0].disabled = !0
                }
                function T(e) {
                    e.data("submitting", !1),
                    e.find(".ds-post-button").removeClass("ds-waiting").html(C.post)[0].disabled = !1
                }
                var n = this,
                r = n.embedThread,
                s = r.options,
                ...
                a = n.el = i($.replybox(r, e)).click(u),
                f = a.find("form"),
                l = f.find("input[type=checkbox]")[0],
                c = f.find("a.ds-service-icon, a.ds-service-icon-grey"),
                p = j(f.find("textarea")).focus(u).keyup(g).keyup(A).bind("focus mousedown mouseup keyup", v),
                m = a.find(".ds-add-emote").click(function(e) {
                    var r = b.smiliesTooltip;
                    return m.toggleClass("ds-expanded").hasClass("ds-expanded") ? (r || (r = b.smiliesTooltip = new P.SmiliesTooltip, r.render(), b.require("smilies",
                    function() {
                        r.reset("\u5fae\u535a-\u9ed8\u8ba4")
                ...
                y = a.find(".ds-add-image").click(function(e) {
                    ...
                    s = '<img src="' + i + '" />';
                    if (t.selection) {
                        n.value = r.substring(0, d.start) + s + r.substring(d.end, r.length),
                ...
                w = n.hideSmilies = function(e) {
                    m.removeClass("ds-expanded"),
                    b.smiliesTooltip.el.detach(),
                    i(t.body).unbind("click", w)
                },
                E = function(e, t) {
                    var n = B('<h2>\u793e\u4ea4\u5e10\u53f7\u767b\u5f55</h2><div class="ds-icons-32">' + i.map(["weibo", "qqt"],
                    function(e) {
                ...
                var N = function(e) {
                    x(f),
                    L("/index.php?m=comment&c=index&a=create", i.extend(b.toJSON(f), e),
                    function(e) {
                        var t = e.response,
                        i = dt(n.postList, t, s);
                        s.order == "asc" == (s.formPosition == "top") && b.scrollTo(i),
                        st[t.post_id] = new Z(t),
                        r.data.comments++,
                ...
                i(l).change(function() {
                    ...
                    this.value = i.map(c, k).join(",")
                }),
                this
            }
        },
        P.Dialog = Y.extend({
            init: function(e, t) { (this.el = i("#ds-wrapper"))[0] || (this.el = H(i('<div id="ds-wrapper"></div>'))),
            ...
            open: function() {
                ...
                E && e.el.css("top", s.scrollTop() + 100),
        ...
        $.likeTooltip = function(e) {
            ...
            n = [];
            for (var r in t) n.push('<li><a class="ds-share-to-' + r + " ds-service-link ds-" + r + '" href="' + b.hostUrl + "/index.php?m=comment&c=index&a=share&" + b.param({
                service: r,
        ...
        P.Meta.prototype = {
            render: function() {
                ...
                a = u.find(".ds-like-thread-button").click(function(f) {
                    ...
                    L("/index.php?m=comment&c=index&a=threads_vote", {
                    ...
                    return l ? r.tooltip && c(f) : (r.tooltip === n && (r.tooltip = i($.likeTooltip(o)).click(m).delegate("a", "click",
                    function(t) {
        ...
        P.PostListHead.prototype = {
            render: function() {
                var e = this.embedThread,
                t = e.options,
                n = e.postList,
                r = this.el = i($.postListHead(e)),
        ...
        P.SmiliesTooltip.prototype = {
            render: function() {
                var e = this,
                n = e.el = i($.smiliesTooltip(I));
                return n.click(m).find("ul.ds-smilies-tabs").delegate("a", "click",
                function(t) {
                ...
                function(n) {
                    ...
                    s = i.value;
                    if (t.selection) {
                        i.value = s.substring(0, d.start) + this.title + s.substring(d.end, s.length),
                        i.value = i.value.replace(C.leave_a_message, ""),
                        i.focus();
                        var o = t.selection.createRange();
                        o.moveStart("character", d.start + this.title.length),
                        o.collapse(),
                        o.select()
                    } else {
        ...
        $.post = function(e, t) {
            ...
            case "qqt":
            case "weibo":
                o += '<span class="ds-time">' + b.sourceName[e.source] + '</span><a class="ds-post-reply" href="javascript:void(0);"><span class="ds-icon ds-icon-reply"></span>' + C.reply + "</a>" + $.likePost(e) + '<!--<a class="ds-post-repost" href="javascript:void(0);"><span class="ds-icon ds-icon-share"></span>' + C.repost + "</a>-->" + '<a class="ds-post-report" href="javascript:void(0);"><span class="ds-icon ds-icon-report"></span>' + C.report + "</a>" + (e.privileges["delete"] ? '<a class="ds-post-delete" href="javascript:void(0);"><span class="ds-icon ds-icon-delete"></span>' + C["delete"] + "</a>": "");
                break;
            default:
            }
            return '<li class="ds-post" data-post-id="' + e.post_id + '"><div class="ds-post-self" data-post-id="' + e.post_id + '" data-thread-id="' + e.thread_id + '" data-root-id="' + e.root_id + '" data-source="' + e.source + '"><div class="ds-avatar"' + r + ">" + $.avatar(n) + (b.sourceName[e.source] ? $.serviceIcon(e.source) : "") + '</div><div class="ds-comment-body"><div class="ds-comment-header">' + (n.url ? '<a class="ds-user-name ds-highlight" data-qqt-account="' + s + '" href="' + h(n.url) + '" rel="nofollow" target="_blank"' + r + ">" + h(n.name) + "</a>": '<span class="ds-user-name"' + r + ' data-qqt-account="' + s + '">' + h(n.name) + "</span>") + "</div>" + (t.max_depth == 1 && t.show_context && u.length ? '<ol id="ds-ctx">' + i.map(u,
            function(e, t) {
                return (t == 1 && u.length > 2 ? '<li class="ds-ctx-entry ds-ctx-entry-more"><a href="javascript:void(0);" class="ds-expand">\u8fd8\u6709' + (u.length - 2) + "\u6761\u8bc4\u8bba</a></li>": "") + (st[e] ? $.ctxPost(st[e].data, t, t && t < u.length - 1) : "")
            }).join("") + "</ol>": "") + "<p>" + (u.length >= t.max_depth && (!t.show_context || t.max_depth > 1) && e.parent_id && st[e.parent_id] ? '<a class="ds-comment-context" data-post-id="' + e.post_id + '" data-parent-id="' + e.parent_id + '">' + C.reply_to + h(J(st[e.parent_id].data).name) + ": </a>": "") + e.message + '</p><div class="ds-comment-footer ds-comment-actions' + (e.vote > 0 ? " ds-post-liked": "") + '">' + o + "</div></div></div>" + (t.max_depth > 1 && (e.childrenArray || e.children) ? '<ul class="ds-children">' + i.map(e.childrenArray || e.children,
            function(e) {
                return st[e] ? $.post(st[e].data, t) : ""
            }).join("") + "</ul>": "") + "</li>"
        };
        var Q = i('<div id="ds-bubble"><div class="ds-bubble-content"></div><div class="ds-arrow ds-arrow-down ds-arrow-border"></div><div class="ds-arrow ds-arrow-down"></div></div>'),
        G = Q.find(".ds-bubble-content").delegate("a.ds-ctx-open", "click",
        function(e) {
            k("/index.php?m=comment&c=index&a=conversation", {
        ...
        Q.mouseenter(pt).mouseleave(bubbleOut),
        $.userInfo = function(e) {
            var t = [];
        ...
        D.PostList.prototype = {
            url: "/index.php?m=comment&c=index&a=list_posts",
            render: function() {
            ...
            refetch: function() {
                var e = this,
                n = i($.indicator()).appendTo(t.body).fadeIn(200);
                e.el.fadeTo(200, .5),
                k(e.url, e.params,
                function(t) {
                    ut(st, t.parentPosts || t.relatedPosts),
                    ut(ot, t.users),
                    e.reset(t.response),
        ...
        b.repostDialog = function(e, t, n, r) {
            var i = B('<h2>\u8f6c\u53d1\u5230\u5fae\u535a</h2><div class="ds-quote"><strong>@' + h(J(e.data).name) + "</strong>: " + e.data.message + "</div>" + "<form>" + K({
                post_id: e.data.post_id
            }) + '<div class="ds-textarea-wrapper">' + '<textarea name="message" title="Ctrl+Enter\u5feb\u6377\u63d0\u4ea4" placeholder="' + h(C.repost_reason) + '">' + h(t) + "</textarea>" + '<pre class="ds-hidden-text"></pre>' + "</div>" + '<div class="ds-actions">' + (r ? K({
                "service[]": r
            }) : '<label><input type="checkbox" name="service[]" value="weibo"' + (nt.data.social_uid.weibo ? ' checked="checked"': "") + ' /><span class="ds-service-icon ds-weibo"></span>\u65b0\u6d6a\u5fae\u535a</label>  ' + '<label><input type="checkbox" name="service[]" value="qqt"' + (nt.data.social_uid.qq ? ' checked="checked"': "") + ' /><span class="ds-service-icon ds-qqt"></span>\u817e\u8baf\u5fae\u535a</label>') + '<button type="submit">' + C.repost + "</button>" + "</div>" + "</form>"),
            s = i.el.find("form").submit(function(e) {
                return ! r && !s.find("[type=checkbox]:checked")[0] ? (alert("\u8fd8\u6ca1\u6709\u9009\u53d1\u5e03\u5230\u54ea\u513f\u5462"), !1) : (L("/api/posts/repost", b.toJSON(s),
                function(e) {
                    if (n && r) {
                        var t = n.options,
        ...
        P.EmbedThread = R.extend({
            ...
            render: function() {
                var e = this.el.attr("id", "ds-thread").append($.waitingImg()),
                t = e.width(),
                n = e.data("url") || !e.attr("data-thread-id") && i("link[rel=canonical]").attr("href");
                n ? e.data("url", p(n)) : e.data("container-url", r.href),
            ...
            updateCounter: function(e) {
                ...
                for (var n in t) if (!e || e == n) {
                    ...
                    if (cnum = document.getElementById('c_num')) {
                        cnum.innerHTML = this.data[t['duoshuo'][0]];
            ...
            onload: function(t) {
                ...
                f = r.innerEl = H(i('<div id="ds-reset"></div>').appendTo(r.el));
                r.data = t.thread,
                ut(st, t.parentPosts || t.relatedPosts),
                ut(ot, t.users),
                r.el.find("#ds-waiting").remove(),
                a.like_thread_enabled && (r.meta = new P.Meta(r), r.meta.render().el.appendTo(f)),
                a.hot_posts && t.hotPosts && t.hotPosts.length && (r.hotPosts = new P.HotPosts(i('<div class="ds-rounded"></div>'), {
                    max_depth: 1,
                ...
                r.postListHead = new P.PostListHead(r),
                r.postList = new D.PostList({
                    embedThread: r,
                    params: {
                        source: "duoshuo",
                        thread_id: s,
                ...
                r.paginator = new P.Paginator({
                    collection: r.postList
                }),
                r.paginator.reset(u);
                var l = r.replybox = new P.Replybox(r),
                ...
                if (lt()) {
                    var p = i($.loginButtons()).delegate("a.ds-more-services", "click",
                    function() {
                        return p.find(".ds-additional-services").toggle(),
                        !1
                    });
                    M(p)
                } else r.toolbar = i($.toolbar()).delegate(".ds-account-control", "mouseenter",
                function() {
                ...
                i($.poweredBy(a.poweredby_text)).appendTo(f),
                rt.on("reset",
                function() {
                    var e = rt.data.comments || 0;
                    f.find("a.ds-unread-comments-count").html(e).attr("title", e ? "\u4f60\u6709" + e + "\u6761\u65b0\u56de\u590d": "\u4f60\u6ca1\u6709\u65b0\u56de\u590d").css("display", e ? "inline": "none")
                }),
                a.mzadx_id && (b.require("mzadxN",
                function() {}), i('<div id="MZADX_' + a.mzadx_id + '"></div>').appendTo(f), __mz_rpq = e.__mz_rpq || [], __mz_rpq.push({
                    l: [a.mzadx_id],
                    r: "1",
                    _srv: "MZADX",
                    _callback: function(e, t) {
                        F("duoshuo_mzadx_flag1 : " + e),
                        F("duoshuo_mzadx_flag2 : " + t)
                    }
                })),
                b.thread = r,
                rt.data !== n && rt.trigger("reset"),
                lt() || _({
        ...
        $.hotPosts = function(e, t) {
            return '<div class="ds-header ds-gradient-bg">' + C.hot_posts_title + "</div><ul>" + i.map(e,
            function(e) {
                return st[e] ? $.post(st[e].data, t) : ""
            }).join("") + "</ul>"
        },
        ...
        $.commentList = function(e, t) {
            ...
            function(e) {
                ...
                return '<li class="ds-comment' + (t.show_avatars ? " ds-show-avatars": "") + '" data-post-id="' + e.post_id + '">' + (t.show_avatars ? '<div class="ds-avatar">' + $.avatar(n, t.avatar_size) + "</div>": "") + (t.show_title ? '<div class="ds-thread-title">\u5728 <a href="' + h(e.thread.url + "#comments") + '">' + h(e.thread.title) + '</a> \u4e2d\u8bc4\u8bba</div><div class="ds-excerpt">' + e.message + "</div>": '<a class="ds-excerpt" title="' + h(e.thread.title) + ' \u4e2d\u7684\u8bc4\u8bba" href="' + h(e.thread.url + "#comments") + '">' + e.message + "</a>") + "</li>"
            }).join("")
        },
        P.RecentComments = R.extend({
        ...
        P.RecentVisitors = R.extend({
            ...
            render: function() {
                ...
                this.el.attr("id", "ds-recent-visitors").append(this.waitingEl = i($.waitingImg()))
            }
        }),
        ...
        P.TopUsers = R.extend({
            uri: "/index.php?m=comment&c=index&a=topusers",
            params: "show-time avatar-size num-items channel-key",
            tmpl: "topUsers",
            render: function() {
                this.el.children().detach(),
                this.el.attr("id", "ds-top-users").append(this.waitingEl = i($.waitingImg()))
            }
        }),
        ...
        P.TopThreads = R.extend({
            uri: "/index.php?m=comment&c=index&a=topthreads",
            params: "range num-items channel-key",
            tmpl: "topThreads",
            render: function() {
                this.el.children().detach(),
                this.el.attr("id", "ds-top-threads").append(this.waitingEl = i($.waitingImg()))
            }
        }),
        $.loginWidget = function() {
            var e = '<div class="ds-icons-32">';
            return i.each(["weibo", "qqt"],
            function(t, n) {
                e += '<a class="ds-' + n + '" href="' + $.loginUrl(n) + '">' + b.sourceName[n] + "</a>"
            }),
            e + "</div>"
        },
        P.LoginWidget = R.extend({
            tmpl: "loginWidget",
            render: function() {
                var e = this.el;
                e.attr("id", "ds-login").html($.loginWidget()),
                M(e, "a"),
                e.find("a.ds-logout").attr("href", $.logoutUrl())
            }
        }),
        P.ThreadCount = R.extend({
            onload: function(e) {
                var t = this.el,
        ...
        b.initSelector = function(e, t) {
            ...
            n.length && k("/index.php?m=comment&c=index&a=counts", bt({
                threads: n.join(",")
            }),
            function(e) {
                c(e),
        ...
        i(function() {
            if (!X()) return F("\u7f3a\u5c11duoshuoQuery\u7684\u5b9a\u4e49");
            ...
            2e4),
            U.ondomready && U.ondomready(),
            b.initView(),
            !yt && U.short_name && k("/index.php?m=comment&c=index&a=ping", bt({}), c)
        })
    })
})(window, document);