...
{
	var unit_id     = "2033179";
	var client_ip   = "101.226.178.67";
	var server_time = "1416642128";
	var verify_code = "1fecaec9";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2033179/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
